...
class adminUSistema extends JFrame implements KeyListener
{
	...
	/*Variables Basicas*/
	public String [] titulos = {"Login", "Nombre", "Apellidos", "Telefono", "Direccion", "Permisos"};
	public String [] orden = {"Login", "Nombre", "Permisos", "Fecha"};
	public JTable tabla;
	public JScrollPane desplazar;
	/*Estilos Generales*/
	JButton color;
	
	public adminUSistema()
	{
		new JFrame("Administrar Usuarios del Sistema");
		setLayout(null);
		getContentPane().setBackground(new Color(187, 187, 187));
		/*Estilo General*/
		color=new JButton("");
		color.setBounds(0, 0, 800, 10);
		color.setBackground(new Color(51, 51, 51));
		color.setBorderPainted(false);
		add(color);
		/*Estilo General*/
		/*Titulo*/
		JLabel tituloMenu=new JLabel("Administrar Usuarios del Sistema");
		...
		botonAgregar.setBackground(new Color(187, 187, 187));
		add(botonAgregar);
		...
		botonModificar.setBackground(new Color(187, 187, 187));
		add(botonModificar);
		...
		botonBorrar.setBackground(new Color(187, 187, 187));
		add(botonBorrar);
		...
		botonOrdenar.setBackground(new Color(187, 187, 187));
		add(botonOrdenar);
		...
		botonSalir.setBackground(new Color(187, 187, 187));
