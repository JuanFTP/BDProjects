...
class infoEgresos extends JFrame implements KeyListener
{
	...
	/*Variables Basicas*/
	public String [] titulos = {"IDEgr", "Fecha", "Concepto", "Importe", "Acreedor"};
	public String [] orden = {"IDEgr", "Fecha", "Importe", "Acreedor"};
	public JTable tabla;
	...
	public infoEgresos()
	{
		new JFrame("Informe de Egresos");
		setLayout(null);
		getContentPane().setBackground(new Color(185, 217, 247));
		/*Estilo General*/
		color=new JButton("");
		color.setBounds(0, 0, 800, 10);
		color.setBackground(new Color(30, 136, 229));
		color.setBorderPainted(false);
		add(color);
		/*Estilo General*/
		/*Titulo*/
		JLabel tituloMenu=new JLabel("Informe de Egresos");
		...
		botonAgregar.setBackground(new Color(185, 217, 247));
		add(botonAgregar);
		...
		botonModificar.setBackground(new Color(185, 217, 247));
		add(botonModificar);
		...
		botonBorrar.setBackground(new Color(185, 217, 247));
		add(botonBorrar);
		...
		botonOrdenar.setBackground(new Color(185, 217, 247));
		add(botonOrdenar);
		...
		botonSalir.setBackground(new Color(185, 217, 247));
