...
class adminContratos extends JFrame implements KeyListener
{
	...
	/*Variables Basicas*/
	public String [] titulos = {"Folio", "Fecha", "Descripcion", "Observaciones", "Tipo", "T/Pago", "Usuario"};
	public String [] orden = {"Folio", "Fecha", "Tipo", "Tipo/Pago", "Usuario"};
	public JTable tabla;
	...
	adminContratos(String userUpper)
	{
		new JFrame("Administrar Contratos");
		setLayout(null);
		getContentPane().setBackground(new Color(254, 233, 197));
		/*Estilo General*/
		color=new JButton("");
		color.setBounds(0, 0, 800, 10);
		color.setBackground(new Color(250, 173, 48));
		color.setBorderPainted(false);
		add(color);
		/*Estilo General*/
		/*Titulo*/
		JLabel tituloMenu=new JLabel("Administrar Contratos");
		...
		botonAgregar.setBackground(new Color(254, 233, 197));
		add(botonAgregar);
		...
		botonModificar.setBackground(new Color(254, 233, 197));
		add(botonModificar);
		...
		botonBorrar.setBackground(new Color(254, 233, 197));
		add(botonBorrar);
		...
		botonOrdenar.setBackground(new Color(254, 233, 197));
		add(botonOrdenar);
		...
		botonSalir.setBackground(new Color(254, 233, 197));
		...
		botonSalir.addActionListener(new ActionListener()
		{
			...
			{
				administrador admin=new administrador(userUpper);
